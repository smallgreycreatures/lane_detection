function [each_img_error_left, each_img_error_right, average_error_left, averrage_error_right] = calculate_error(estimated_left, estimated_right, ground_left, ground_right)
